...
if __name__ == "__main__":
    ...
    df1 = pd.read_sql(
        ...
        SELECT 
            a.*, 
            b.geo_censustract2010 AS ct2010, 
            b.geo_boro AS boro
    ...
    df1 = df1[
        ["unit_exist_preapr2010", "unit_change_postapr2010"]
        + unit_change
        + ["boro", "ct2010"]
    ]
    ...
    df2 = pd.read_sql(
        ...
        AND geo_censustract2010 != '000000';
        """,
        engine,
    )
