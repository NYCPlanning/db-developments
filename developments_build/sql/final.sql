...
SELECT 
	...
	COALESCE(geo_boro, (select boro from _INIT_devdb where uid = uid))||geo_censustract2010||geo_censusblock2010 as bctcb2010,
	COALESCE(geo_boro, (select boro from _INIT_devdb where uid = uid))||geo_censustract2010 as bct2010,
