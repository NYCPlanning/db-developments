...
CORRECTIONS: 
	...
	date_statusx
*/
CALL apply_correction('_INIT_devdb', 'housing_input_research', 'stories_prop', 'stories_prop');
CALL apply_correction('_INIT_devdb', 'housing_input_research', 'bin', 'bin');
CALL apply_correction('_INIT_devdb', 'housing_input_research', 'bbl', 'bbl');
CALL apply_correction('_INIT_devdb', 'housing_input_research', 'date_lastupdt', 'date_lastupdt');
CALL apply_correction('_INIT_devdb', 'housing_input_research', 'date_filed', 'date_filed');
CALL apply_correction('_INIT_devdb', 'housing_input_research', 'date_statusd', 'date_statusd');
CALL apply_correction('_INIT_devdb', 'housing_input_research', 'date_statusp', 'date_statusp');
CALL apply_correction('_INIT_devdb', 'housing_input_research', 'date_statusr', 'date_statusr');
CALL apply_correction('_INIT_devdb', 'housing_input_research', 'date_statusx', 'date_statusx');
